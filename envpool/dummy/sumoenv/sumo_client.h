...
class SumoClient {
 ...
 public:
    SumoClient(
        ...
        const int random_seed  // ramdom_seed is generated by dist(gen_)
        ...
        random_seed_(random_seed) {
            SetSimulation(random_seed_);  // 也就是说在构造函数中，我们会使用类的成员函数random_seed_初始化第一个sumulation实例，但是在后续reset的过程中，我们会主动传入random_seed_
            SetTrafficLights();
            SetStrategies();
        }
